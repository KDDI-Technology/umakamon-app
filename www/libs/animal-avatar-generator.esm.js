...
const avatar = (seed, { size = 150, avatarColors: avatarColors$1 = avatarColors, backgroundColors: backgroundColors$1 = backgroundColors, blackout = true, round = true, } = {}) => {
    const random = seedrandom(seed);
    const backgroundColor = pick(backgroundColors$1, random());
    const avatarColor = pick(avatarColors$1, random());
